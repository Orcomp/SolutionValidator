	...
	public static class ConfigurationExtensions
	{
		...
		private static void CreateProjectFileContext(SolutionValidatorConfigurationSection configuration, ValidatorContext validatorContext)
		{
			...
			if (configuration.ProjectFile.CheckIdentical != null)
			{
				...
				{
					validatorContext.ProjectFile.IdenticalChecks.Add(new IdenticalCheck {PropertyName = propertiesToMatchElement.PropertyName, OtherPropertyName = propertiesToMatchElement.OtherPropertyName});
				}
			}
